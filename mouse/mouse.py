...
button_font = ('Helvetica', 12, 'bold italic')

# Welcome label
label = tk.Label(root, text="Welcome to Zaizir Biahthu Virtual Mouse", fg="brown", font=title_font) 
label.grid(row=0, column=0, columnspan=3, pady=(20, 10), padx=10) 

# Image label
image = ImageTk.PhotoImage(Image.open("tap.png")) 
img_label = tk.Label(root, image=image, borderwidth=3, relief="solid") 
img_label.grid(row=1, column=0, columnspan=3, pady=10, padx=10) 

# Start button
start_button = tk.Button(root, text="Start", fg="white", bg='green', font=button_font, command=runvirtualmouse, height=3, width=20, activebackground='lightblue') 
start_button.grid(row=2, column=1, pady=20, padx=10) 
